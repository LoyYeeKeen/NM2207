...
**Solution:**  Name of social media platform (Non-numeric character)
Number of users for each platform (Numeric integer)
Hours spent on each platform per week(Numeric double)
