...
**Solution:** 1. There are multiple variables (year, event) in the same column. Put these variables in separate columns.
2. In the Percentage column, the 2nd, 10th, 13th, 18th and 21st rows have data corresponding to a different variable. We should create a new column for these data.