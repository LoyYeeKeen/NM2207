...
In each dataset, there are 3 columns, corresponding to the name of the baby, the gender of the baby and the count of babies with that name and gender (The original dataset did not define the names of the variables, so I will redefine the variables as Name, Gender and Count). 
